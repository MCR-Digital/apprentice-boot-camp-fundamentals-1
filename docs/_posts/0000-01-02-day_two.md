...
* How did you remove your duplication?
* Reflect on what we observed

---

* Show examples of duplication
* Show examples of not duplication—tests/declarative
* Rewrite the thing they looked at before to remove duplication
  * Duplication of item names or costs in receipt code?
  * Duplication of code to print out newlines etc?
